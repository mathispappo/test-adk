...
class CloudRunCodeLlama(CustomLLM):
    ...
    def completion(self, messages: list, model: str = None, **kwargs) -> litellm.ModelResponse:
    ...
    async def acompletion(self, messages: list, model: str = None, **kwargs) -> litellm.ModelResponse:
...
litellm.custom_provider_map = [
    {
        "provider": "cloud-run",
        "custom_handler": cloud_run_handler
    }
]
