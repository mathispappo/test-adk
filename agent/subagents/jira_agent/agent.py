...
class JiraAgent:
    ...
    def _create_agent(self) -> LlmAgent:
        return LlmAgent(
            ...
            instruction="""
                You are a JIRA ticket assistant. Your role is to help users create and manage well-structured JIRA tickets.
                When a user provides a request for a ticket, analyze the request and propose ticket details.
                ...
                You need to answer question uniquely based on the JiraAgent.
                If there is nothing relevant in the JiraAgent, you should not answer the question, leaving it unanswered, don't write anything.
